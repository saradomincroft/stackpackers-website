        ...
        {logoAnimationCompleted && imageLoaded && (
          ...
          >
            <svg
              ...
              className={`w-12 sm:w-24 md:w-24 lg:w-32 h-auto transition-transform duration-300 ease-in-out hover:scale-110 ${styles.arrowFadeIn} ${styles.arrowGlowAndBurst}`}
